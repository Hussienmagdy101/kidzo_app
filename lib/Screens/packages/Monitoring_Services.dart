...
import 'package:kidzo_app/Screens/packages/user_Usage.dart';
...
Future<void> _startTimer(  Map<String, ApplicationData> monitoredApplicationSet, Map<String, UsageInfo> previousUsageSession) async{
  Timer.periodic(const Duration(seconds: 1), (timer) async{
    timer.cancel();
    _setMonitoringApplicationsSet( monitoredApplicationSet);
