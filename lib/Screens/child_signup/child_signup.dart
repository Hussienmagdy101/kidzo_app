...
import 'package:kidzo_app/Screens/child_homepage/childHP.dart';
import 'package:kidzo_app/Screens/packages/appInformation.dart';
import 'package:kidzo_app/Screens/packages/child.dart';
import 'package:kidzo_app/Screens/parent_login/login_imports.dart';
import 'package:kidzo_app/Screens/parent_signUp/signup_widgets/already_have_account.dart';
import 'package:kidzo_app/Screens/parent_signUp/signup_widgets/signup_text_field.dart';
  ...
  Future signUp() async {
    try {
      ...
      if (parentId.isNotEmpty) {
        ...
        // //   'Name': childUsernameController.text,
        // //   'Email': childEmailController.text,
        // //   'Password': childPasswordController.text,
        // //   'Parentid': parentId,
